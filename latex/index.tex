...
\begin{DoxyItemize}
\item Installeer het project Free\+RTOS\+\_\+\+GPS\+\_\+407 in \href{https://www.st.com/en/development-tools/stm32cubeide.html}{\texttt{ STM32\+Cube\+IDE}}. Importeer daarvoor het bestand Free\+RTOS\+\_\+\+GPS\+\_\+407.\+ioc. 
...
\begin{DoxyItemize}
\item {\itshape didactisch}. Het toont de opzet en werking van verschillende free\+RTOS-\/mechanismen. Soms is in de code op didactische gronden gekozen voor een of ander mechanisme, terwijl dit ook anders opgelost had kunnen worden.
\item als {\itshape basis} (skeleton) om verder uit te werken voor het {\itshape project}. Nu hoef je als student niet alles from scratch zelf te bouwen. Het is wel aan jou om goed te kijken welke onderdelen van de code je voor jouw applicatie kunt gebruiken en welke je kunt verwijderen.
\end{DoxyItemize}
...
\item {\bfseries{5}}\+: On/\+Off GPS-\/data output (mits een GPS-\/receiver aangesloten is). 
...
Hieronder zie je de voor deze applicatie belangrijkste bestanden. De applicatie bevindt zich in de map {\bfseries{Core}}, en wel hoofdzakelijk in de map {\bfseries{My\+App}}, die weer verdeeld is in App en Ports. Daarnaast zie je in Core nog de map {\bfseries{Src}}, die door STM gegenereerde bestanden bevat. \tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
{\bfseries{\mbox{[}Core/\+Src\mbox{]}}} &{\bfseries{Bevat de door STM gegenereerde bestanden}}  \\\cline{1-2}
\doxylink{main_8c}{main.\+c} &ISR voor UART (\doxylink{_u_a_r_t__keys_8c}{UART\+\_\+keys.\+c}), blijf ik verder zoveel mogelijk uit...  \\\cline{1-2}
\doxylink{stm32f4xx__it_8c}{stm32f4xx\+\_\+it.\+c} &ISR voor \doxylink{_a_r_m__keys_8c}{ARM\+\_\+keys.\+c}  \\\cline{1-2}
~ &\\\cline{1-2}
{\bfseries{\mbox{[}Core/\+My\+App/\+App\mbox{]}}} &{\bfseries{Bevat de applicatie-\/code (Michiel Scager)}}  \\\cline{1-2}
\doxylink{admin_8c}{admin.\+c} &versie-\/beheer~\newline
kleine algemene functies;~\newline
{\bfseries{alle handles en alle taken (tasks, threads) worden hier aangemaakt}}  \\\cline{1-2}
\doxylink{admin_8h}{admin.\+h} &\#defines, structs, externals, etc.  \\\cline{1-2}
\doxylink{gps_8c}{gps.\+c} &verwerking van de inkomende GPS-\/data (UART)  \\\cline{1-2}
\doxylink{ledjes_8c}{ledjes.\+c} &hier gaan wat tasks met ledjes spelen  \\\cline{1-2}
\doxylink{_u_a_r_t__keys_8c}{UART\+\_\+keys.\+c} &afhandeling UART-\/input via ISR in \doxylink{main_8c}{main.\+c}  \\\cline{1-2}
\doxylink{_a_r_m__keys_8c}{ARM\+\_\+keys.\+c} &afhandeling ARM-\/toetsen via ISR in \doxylink{stm32f4xx__it_8c}{stm32f4xx\+\_\+it.\+c}  \\\cline{1-2}
\doxylink{student_8c}{student.\+c} &speeltuin voor studenten  \\\cline{1-2}
~ &\\\cline{1-2}
{\bfseries{\mbox{[}Core/\+Myapp/\+Ports\mbox{]}}} &{\bfseries{Bevat ARM-\/port-\/functies (Franc van der Bent)}}  \\\cline{1-2}
buzzer.\+c &\\\cline{1-2}
uart.\+c &\\\cline{1-2}
leds.\+c &\\\cline{1-2}
lcd.\+c &\\\cline{1-2}
