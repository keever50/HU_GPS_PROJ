...
{ UART_menu,    NULL, .attr.name = "UART_menu",    .attr.stack_size = 128 * 6, .attr.priority = osPriorityBelowNormal6 },
  ...
  // gps.c
{ GPS_getNMEA,  NULL, .attr.name = "GPS_getNMEA",  .attr.stack_size = 128 * 6, .attr.priority = osPriorityNormal2 },

  // student.c
{ Student_task1,NULL, .attr.name = "Student_task1",.attr.stack_size = 128 * 12, .attr.priority = osPriorityBelowNormal7 },
